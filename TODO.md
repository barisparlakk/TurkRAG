...
- [x] `dashboard/src/components/ChatWindow.jsx` and `dashboard/src/index.css`: correct the over-dark evidence-desk direction by making the chat UX composer-first, improving the evidence/scope flow, and replacing the muddy color treatment with a warmer premium enterprise palette.
